package com.github.dawndev.orion.core.akka;
...
public class SpringExtension extends AbstractExtensionId<SpringExtension.SpringExt> {
    ...
    //@since 2020/10/22
    public ActorRef actorOf(ActorSystem actorSystem, String actorSpringBeanName, String dispatcher, String actorLogicalName) {
        return actorSystem.actorOf(get(actorSystem).props(actorSpringBeanName).withDispatcher(dispatcher), actorLogicalName);
    }
